    ...
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items">
          {items.map((pizza) => {
            // разделение каждой пиццы по размеру и типу теста
            return sizeTypes.map(
              (st) =>
                pizza[st] && (
                  <div className="cart__item" key={st+pizza.name}>
                    ...
                    <div className="cart__item-info">
                      <h3>{pizza.name}</h3>
                      <p>
                        {st.split("-")[0] ? "традиционное" : "тонкое"},{" "}
                        {st.split("-")[1]} см.
                      </p>
                    </div>
                    <div className="cart__item-count">
                      <div className="button button--outline button--circle cart__item-count-minus" onClick={() => dispatch(removeItem({...pizza, type: st.split('-')[0], size: st.split('-')[1]}))}>
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 10 10"
                      ...
                      <b>{pizza[st]}</b>
                      <div className="button button--outline button--circle cart__item-count-plus" onClick={() => dispatch(addItem({...pizza, type: st.split('-')[0], size: st.split('-')[1]}))}>
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 10 10"
